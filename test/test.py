...
class TestTransBin9601(ut.TestCase):
    ...
    def test_read_binary_signal_file(self):
        ...
        self.assertTrue(
            header_str
            == "00050000000000009601    * rccircuit.sp                                                  06/05/2020      15:06:55 Copyright (c) 1986 - 2020 by Synopsys, Inc. All Rights Reserved.          0                                                                              1       1       1       1       8     TIME            v(0             v(vo            v(vs            i(vs            $&%#    "
        )
    ...
    def test_general_make_dict(self):
        ...
        data_dict, _, _, _ = general_make_dict(
            var_lst, sweep_lst, header_str, False
        )  # the test file has no sweeps (break by sweep still has a purpose though
...
class TestACBin9601(ut.TestCase):
    ...
    def test_read_binary_signal_file(self):
        ...
        self.assertEqual(
            header_str,
            "00050000000000009601    * rccircuit.sp                                                  04/23/2021      19:22:51 Copyright (c) 1986 - 2021 by Synopsys, Inc. All Rights Reserved.          0                                                                              2       1       1       1       8     HERTZ           v(0             v(vo            v(vs            i(vs            $&%#    ",
        )
...
class TestDCSweepBin9601(ut.TestCase):
    ...
    def test_read_binary_signal_file(self):
        ...
        self.assertTrue(
            header_str
            == "00050000000000009601    * rccircuit.sp                                                  04/16/2021      00:57:08 Copyright (c) 1986 - 2021 by Synopsys, Inc. All Rights Reserved.          0                                                                              3       1       1       1       8     r1              v(0             v(vo            v(vs            i(vs            $&%#    "
        )
...
class TestTranBin2001(ut.TestCase):
    ...
    def test_read_binary_signal_file(self):
        ...
        self.assertTrue(
            header_str
            == "000500000000000000002001* rccircuit.sp                                                  06/05/2020      15:22:51 Copyright (c) 1986 - 2020 by Synopsys, Inc. All Rights Reserved.          0                                                                              1       1       1       1       8     TIME            v(0             v(vo            v(vs            i(vs            $&%#    "
        )
